...
local iconTextures = {};
iconTextures[RUNETYPE_BLOOD] = "Interface\\PlayerFrame\\UI-PlayerFrame-Rune-Fel";
iconTextures[RUNETYPE_UNHOLY] = "Interface\\PlayerFrame\\UI-PlayerFrame-Rune-Arcane";
iconTextures[RUNETYPE_FROST] = "Interface\\PlayerFrame\\UI-PlayerFrame-Rune-Shadow";
...
function RuneFrame_OnLoad (self)
	...
	if ( class ~= "DEATHKNIGHT" and class ~= "DEMONHUNTER" ) then
		self:Hide();
	end
