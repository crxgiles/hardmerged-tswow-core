...
export const COLLIDE =
    std.Spells.create('ts-wowintroduction', 'COLLIDE',100)
...
//Set skill line
COLLIDE.SkillLines.add(BRUTE_SKILL.ID)
//Set the icon
COLLIDE.Icon.setPath("Barbarian_Collide")
//Remove Battle Stance req
.ShapeshiftMask.Include.set(BigInt(0))
.ShapeshiftMask.Exclude.set(BigInt(0))
.TargetAuraSpell.Exclude.set(0)
//Remove dummy effect, Generate 10 Rage
.Effects.clear(1)
    .Effects.mod(1, (eff) => {
        eff
            .Type.ENERGIZE.set()
...
//Custom Visual
COLLIDE.Visual.modRefCopy(x=>x
    .CastKit.modRefCopy(x=>x
        .BaseEffect.modRefCopy(x=>x
            .Name.set("DustCloud Land")
            .Filename.set("Spells\\DustCloud_Land.mdx")
            .AreaSize.set(1)
            .Scale.set(1,0.009999999776482582,100)
        )
        .ChestEffect.modRefCopy(x=>x
            .Name.set("Collide Trail Cast")
            .Filename.set("Spells\\Backstab_cast_base.m2")
            .AreaSize.set(0)
    ...
    .ImpactKit.modRefCopy(x=>x
        .ChestEffect.modRefCopy(x=>x
            .Name.set("Collide Impact Chest")
            .Filename.set("SPELLS\\Backstab_impact_chest.m2")
            .AreaSize.set(1)
            .Scale.set(3,0.009999999776482582,100)
        )
        .CameraShake.set(0)
        .Flags.set(0)
        .Sound.set(4120)
...
// Load charge data
console.log(std.Spells.load(100).codify({}));

// Load berserker stance
console.log(std.Spells.load(34846).codify({}));
